...
const AddFacturation = () => {
    ...
    const [clients] = useState(['développement web', 'application gestion', 'Design un site', 'autre']); // Liste des clients
    ...
    return (
        ...
        >
            <h2 className="text-2xl font-semibold mb-6">Ajouter un projet</h2>

            <form className="space-y-6">
                <div>
                    <label htmlFor="client" className="block text-sm font-medium text-gray-700">Listes des projets</label>
                    <select
                        id="client"
                    ...
                    >
                        <option value="">Sélectionner un projets </option>
